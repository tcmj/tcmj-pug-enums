...
/**
 * Compiles and loads your given source enum at runtime. The compiled object will be loaded using the current class loader.
 */
public class InMemoryCompilingExporter implements EnumExporter {
    ...
    @Override public String export(String data, Map<String, Object> options) {
        ...
        try {
            ...
            Class<? extends Enum> enumClass = (Class<? extends Enum>) Class.forName(className, true, classLoader);
