 ...
 * pugproductions - 2017-05-03 - tcmj.
 */
...
//        model.setFieldNames("nameUS", "nameDE", "FlaecheInKM2", "FlaecheInProzent", "HoechsterPunktInMeter", "NiedrigsterPunktInMeter");
        model.setFieldNames("nameUS", "nameDE", "areaKM2", "areaPct", "elevationHighest", "elevationLowest");
        model.setFieldClasses(String.class, String.class, Integer.class, Float.class, Integer.class, Integer.class);
