...
public class NamingStrategyFactoryTest {
    ...
    public void testExtractParenthesis() throws Exception {
        ...
        assertThat("1", extractParenthesis().convert("Bolivia (Plurinational State of)"), equalTo("Plurinational State of Bolivia"));
        assertThat("2", extractParenthesis().convert("Congo (Democratic Republic of the)"), equalTo("Democratic Republic of the Congo"));
        assertThat("3", extractParenthesis().convert(" Korea (Democratic People's Republic of) "), equalTo("Democratic People's Republic of Korea"));
    }
