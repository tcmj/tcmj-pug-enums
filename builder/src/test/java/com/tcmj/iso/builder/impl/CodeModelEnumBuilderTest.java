...
public class CodeModelEnumBuilderTest extends ParentClassBuilderTest {
     ...
     */
    @Test public void shouldCreateEnumWithSingleValueWithAStringSubfield() {
        result = classBuilder
                .withName("org.Animal")
                .addField("DOG", new String[]{"name"}, new Class[]{String.class}, new Object[]{"Goldie"})
                .build();
    ...
    /**
     * package org; public enum TimeUnit { SECONDS(1000L), MILLIES(1L); private final Long factor; TimeUnit(Long factor) { this.factor = factor; } public Long getFactor() { return factor; } }
     */
    @Test public void shouldCreateEnumWithSingleValueWithTwoNumericSubfields() {
        result = classBuilder
        ...
        assertThat("constructor", result, containsString("TimeUnit(Long factor) { this.factor = factor; }"));
