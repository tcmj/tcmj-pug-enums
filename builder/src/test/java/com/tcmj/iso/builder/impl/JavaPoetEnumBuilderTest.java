...
public class JavaPoetEnumBuilderTest extends ParentClassBuilderTest {
    ...
    public void shouldCreateEnumWithSingleValueWithTwoNumericSubfields() {
        ...
        assertThat("constants1", result, anyOf(containsString("SECONDS(1000L)"), containsString("SECONDS(1000)")));
        assertThat("constants2", result, anyOf(containsString("MILLIES(1L)"), containsString("MILLIES(1)")));
