...
/**
 * A simple Java source code builder to create enum objects.
 * This implementation of {@link ClassBuilder} uses a {@link StringBuilder} internally.
 */
public class StringBufferEnumBuilder extends AbstractClassBuilder {
    final StringBuilder buffer = new StringBuilder(TEMPLATE);
    static final String TEMPLATE = "[PACKAGE][IMPORTS][CLSJDOC][STARTCLASS][CONSTANTS][CONSTRUCTOR][CONTENT][ENDCLASS]";
...
//start field variables
    ...
    private void writeSTARTCLASS() {
        String content = PUBLIC_ENUM + Objects.requireNonNull(this.model.getClassNameSimple(), "No class name set! Use .withName(String)!") + " {" + LINE;
...
//start field variables
    ...
    @Override public ClassBuilder addJavadoc(String fieldName, String javaDoc) {
