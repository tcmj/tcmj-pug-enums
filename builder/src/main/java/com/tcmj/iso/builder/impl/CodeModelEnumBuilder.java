...
/**
 * EnumBuilder.
 * Generator used to create the enum: com.sun.codemodel
 * Sun codemodel, part of the GlassFish project
 */
public class CodeModelEnumBuilder extends AbstractClassBuilder {
    ...
    @Override public ClassBuilder withName(String name) {
        ...
        try {
            if (model.getPackageName() == null) {
                this.jclass = codeModel.rootPackage()._class(JMod.PUBLIC, this.model.getPackageName(), ClassType.ENUM);
            } else {
    ...
    @Override public ClassBuilder addCustomStaticGetterMethod(
            String methodName,
            String paramType,
            String paramName,
            String code,
