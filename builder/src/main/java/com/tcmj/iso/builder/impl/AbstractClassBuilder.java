...
/**
 * A skeletal implementation of a {@link ClassBuilder} basically to
 * fill all data into the data model.
 */
public abstract class AbstractClassBuilder implements ClassBuilder {
    ...
    @Override public ClassBuilder withName(String name) {
    ...
    @Override public ClassBuilder usingNamingStrategy(NamingStrategy instance) {
        LOG.debug("...using NamingStrategy: {}", instance);
        this.model.setNamingStrategy(instance);
        return this;
    }

    @Override public ClassBuilder usingCustomFormatter(SourceFormatter object) {
        this.sourceFormatter = Objects.requireNonNull(object, "Null not allowed for SourceFormatter!");
        return this;
    }

    @Override public ClassBuilder addImport(String importTag) {
        this.model.getImports().add(importTag);
        return this;
    }

    @Override public ClassBuilder addClassJavadoc(String text) {
        this.model.addJavaDoc(EnumData.JDocKeys.CLASS.name() , text);
        return this;
    }

    @Override public abstract ClassBuilder addJavadoc(String fieldName, String javaDoc);

    @Override public ClassBuilder setFields(String[] fieldNames, Class[] classes) {
        this.model.setFieldNames(fieldNames);
        this.model.setFieldClasses(classes);
        return this;
    }

    @Override public ClassBuilder addField(String constantName, Object... values) {
        NameTypeValue record = NameTypeValue.of(this.model.getFieldNames(), this.model.getFieldClasses(), values);
        this.model.getData().put(constantName, record);
        return this;
    }

    @Override public ClassBuilder addField(String constantName, String[] fieldNames, Class[] classes, Object[] values) {
        NameTypeValue record = NameTypeValue.of(fieldNames, classes, values);
        this.model.getData().put(constantName, record);
        return this;
    }

    @Override public ClassBuilder addField(String constantName) {
        NameTypeValue record = NameTypeValue.of(null, null, null);
        this.model.getData().put(constantName, record);
        return this;
    }

    @Override public ClassBuilder addCustomStaticGetterMethod(String methodName, String paramType, String paramName, String code, String javaDoc) {
        return this;
    }

    @Override public ClassBuilder overrideGetter(String fieldName, String code, String... javaDoc) {
        this.model.addCustomCode(fieldName, code);
        //todo javadoc
        return this;
    }

    @Override public abstract String build();

    @Override public EnumData getModel(){
        return this.model;
    }
    ...
    protected void validate() {
        ...
        if (StringUtils.isBlank(this.model.getPackageName())) {
            throw new ClassCreationException("No PackageName is set! Use something like .withName(\"com.tcmj.MyEnum\")!");
        }
    }
