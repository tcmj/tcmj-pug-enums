...
public class EnumDataHelper {
    ...
    public static void addConstantValue(EnumData model, String constantName, Object... values) {
        String[] fieldNames = Objects.requireNonNull(model.getFieldNames(),"No field names found in your model! Use EnumData#setFieldNames first!");
        Class[] fieldTypes = Objects.requireNonNull(model.getFieldClasses(),"No field types found in your model! Use EnumData#setFieldClases first!");
...
//        if(model.getFieldNames()!=null || model.getFieldClasses()!=null){
            throw new ClassCreationException("Method is to add enum constant values when no subfields are required!");
        }
